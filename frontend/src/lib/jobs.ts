...
export function waitReasonLabel(reason?: string): string {
 const labels: Record<string, string> = {
   request_not_sent: "请求尚未发送，等待手动恢复", execution_unknown: "原调用结果未知，请在原会话核对后继续", approval: "等待方案审批", approval_delivery: "审批已提交，等待 Grok 确认", approval_delivery_unknown: "审批交付未确认，不会自动重发", approval_expired: "原审批已失效，请继续原会话重新提交", plan_content_missing: "已收到审批请求，但本次方案正文缺失", review_required: "最终回答待验收", tui_active: "TUI 查看中，Codex 请求已排队", handoff: "正在连接交互会话，Codex 请求已排队",
