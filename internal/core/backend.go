...
type Backend interface {
	...
	CancelTurn(ctx context.Context, jobID string, expectedTurnID ...string) (protocol.Job, error)
	CancelRequest(ctx context.Context, jobID, requestID, turnID string) (protocol.Job, error)
	SetView(ctx context.Context, req protocol.SetViewRequest) (protocol.Job, error)
	Status(ctx context.Context, jobID string, options ...protocol.ResultQuery) (protocol.Job, error)
